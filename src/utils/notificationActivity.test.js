...
describe('notificationActivity', () => {
  ...
  it('refreshes for actionable live events but skips noisy session heartbeats', () => {
    ...
    expect(shouldRefreshNotificationsForEvent('developer.broadcast')).toBe(true)
  ...
  it('uses the new developer broadcast style and default notifications center route', () => {
    const notification = {
      type: 'OpsActivityNotification',
      data: {
        kind: 'developer.broadcast',
      },
    }
