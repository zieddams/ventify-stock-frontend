...
export const ACTIVITY_KIND_CONFIG = {
  ...
  'product.created': {
    ...
    label: 'Produit ajoute',
  },
  'product.updated': {
    icon: 'fa-solid fa-pen-ruler',
    color: '#0284c7',
    bg: 'rgba(2,132,199,0.12)',
    label: 'Produit modifie',
  },
  'product.deleted': {
  ...
  'customer.updated': {
    ...
    label: 'Client modifie',
  },
  'customer.deleted': {
    icon: 'fa-solid fa-user-xmark',
    color: '#dc2626',
    bg: 'rgba(220,38,38,0.12)',
    label: 'Client desactive',
  },
  ...
  'expense.created': {
    ...
    color: '#f59e0b',
    bg: 'rgba(245,158,11,0.12)',
    label: 'Depense ajoutee',
  },
  'expense.updated': {
    icon: 'fa-solid fa-file-pen',
    color: '#d97706',
    bg: 'rgba(217,119,6,0.12)',
    label: 'Depense modifiee',
  },
  'expense.deleted': {
    icon: 'fa-solid fa-file-circle-minus',
    color: '#ef4444',
    bg: 'rgba(239,68,68,0.12)',
    label: 'Depense supprimee',
  },
  'inventory.adjusted': {
  ...
  'config.item.created': {
    ...
    color: '#0d9488',
    bg: 'rgba(13,148,136,0.12)',
    label: 'Element de config ajoute',
  },
  'config.item.updated': {
    icon: 'fa-solid fa-sliders',
    color: '#0891b2',
    bg: 'rgba(8,145,178,0.12)',
    label: 'Element de config modifie',
  },
  'config.item.deleted': {
    icon: 'fa-solid fa-sliders',
    color: '#ef4444',
    bg: 'rgba(239,68,68,0.12)',
    label: 'Element de config desactive',
  },
  'settings.updated': {
